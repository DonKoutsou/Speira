...
class SCR_NotificationsComponent : ScriptComponent
{
	...
	*/
	...
	static bool SendToGameMastersNSt(ENotification notificationID, string dialoguetext, int param1 = 0, int param2 = 0, int param3 = 0, int param4 = 0, int param5 = 0)
	{
		return SendToGameMastersNSt(notificationID, vector.Zero, dialoguetext, param1, param2, param3, param4, param5);
	}
	/*!
	Send notification to all players that have GM rights
	\param notificationID ID of the notification message
	...
	*/
	...
	static bool SendToGameMastersNSt(ENotification notificationID, vector position, string dialoguetext, int param1 = 0, int param2 = 0, int param3 = 0, int param4 = 0, int param5 = 0)
	{
		SCR_NotificationData newNotificationData = SCR_NotificationData();
		newNotificationData.SetParametersNSt(ENotificationReceiver.GM_ONLY, dialoguetext, param1, param2, param3, param4, param5);
		newNotificationData.SetPosition(position);
		return SendToGameMastersNStData(notificationID, newNotificationData);
	}
	...
	protected static bool SendToGameMastersNStData(ENotification notificationID, SCR_NotificationData data, int playerID = -1)
	{
		//--- Only server can broadcast messages
		if (!Replication.IsServer()) return false;
