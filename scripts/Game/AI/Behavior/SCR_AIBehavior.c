...
class SCR_AILookAtMeBehavior : SCR_AIBehaviorBase
{
	override float Evaluate()
	{
		return 1;
	...
	void SCR_AILookAtMeBehavior(SCR_AIUtilityComponent utility, SCR_AIActivityBase groupActivity)
	{
		if (!utility)
			return;
		m_sBehaviorTree = "C:\Games\Speira\Speira\Speira\AI\BehaviorTrees\LookAtMe.bt";
	}
};
